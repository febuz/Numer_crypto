"""
GPU utility functions for the Numerai Crypto project.

This module provides utilities for GPU detection, monitoring, and management
to optimize training of models on GPU hardware.
"""
import os
import sys
import logging
...
from numer_crypto.config.settings import HARDWARE_CONFIG, XGBOOST_PARAMS, LIGHTGBM_PARAMS
...
if __name__ == "__main__":
    # Set up logging for script mode
